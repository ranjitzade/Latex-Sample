...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Ranjit}{Zade}{
% \item Mobile Application Developer \\
\urlstyle{same}\href{http://www.ranjitzade.com}{ranjitzade.com} \\
\href{mailto:me@ranjitzade.com}{me@ranjitzade.com} | +91-9049885557 
}
...
\runsubsection{Fanspole Online Solutions Pvt. Ltd.}
\descript{| Android Lead }
\location{Oct 2019 – Present | Mumbai, MH}
...
\runsubsection{Parity Cube Pvt. Ltd.}
\descript{| Sr. Android Developer }
\location{Sep 2016 – Oct 2019 | Mumbai, MH}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
...
% \subsection{Dodaa }
% % \href{http://www.dodaa.app}{(dodaa.app) 
% Currently in beta (dodaa.app), Dodaa is realtime chat application developed in flutter for sports enthusiastic folks. It is super community for Fans interested to pour out their emotions about Sports \& Esports matches.
% One can send texts, bets, and more with a modern chat in their fan room \& to complete with the ability to react to various match moments and betting history.
% \sectionsep
